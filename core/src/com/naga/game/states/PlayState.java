...
import com.naga.game.sprites.Bird;
import com.naga.game.sprites.Tube;
...
public class PlayState extends State{
    ...
    public void update(float dt) {
        ...
        if((scorecount % 105) == 1){
            ...
            System.out.println("score plus plus");
        }
    ...
    public void render(SpriteBatch sb) {
        ...
        font.draw(sb, "Your score: " + score + "", cam.position.x - 100, cam.position.y + 180);
